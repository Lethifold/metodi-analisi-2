...
\begin{document}
	\section*{Integrazione}
		...
		Nel caso di integrali tripli, l'integrazione permette, come nel caso degli integrali doppi, di ricavare un volume, tuttavia in questo caso l'integrale rappresenterà  un volume non più in $ \mathbb{R}^{3} $, bensìin $ \mathbb{R}^{4} $
